                    ...
                    <h4 class="m-1 text-lg text-primary">Product category</h4>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#Small" data-toggle="tab">Small</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#Medium" data-toggle="tab">Medium</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#Large" data-toggle="tab">Large</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#Others" data-toggle="tab">Others</a>
                              </li>

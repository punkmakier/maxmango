...
<body class="bg-gradient-warning">
  ...
  <div class="container bg-gradient-warning">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9 bg-gradient-warning">

        <div class="card o-hidden border-0 shadow-lg my-5 bg-gradient-warning">
          <div class="card-body p-0">
            <!-- Nested Row within Card Body -->
            <div class="row shadow">
              <div class="col-lg-6 d-none d-lg-block " style="background-image: url('../img/maxmango.jpg'); background-size: 100% 100%;"></div>
              <div class="col-lg-6">
                <div class="p-5">
